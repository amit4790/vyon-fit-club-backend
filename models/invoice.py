...
class Invoice(Base):
    ...
    amount_paid_today: Mapped[float | None] = mapped_column(Numeric(10, 2), nullable=True)
    outstanding_balance: Mapped[float | None] = mapped_column(Numeric(10, 2), nullable=True)
    ...
    counsellor: Mapped[str | None] = mapped_column(String(120), nullable=True)
